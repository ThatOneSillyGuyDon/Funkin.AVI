...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Coders'],
			['DEMOLITIONDON96',	'demolitiondon96',	"Main Coder Of Funkin.avi",	'https://youtube.com/c/DEMOLITIONDON96',	'03C6FC'],
			['Jsa010',       	'jsa010',	        "Secondary Coder of Funkin.avi", 'https://twitter.com/_Jsa010_',   	'FF4922'],
		    ['TonyTime',	    'missing-icon',	    'He left but he\'s back',                                                   'https://github.com/TonyTimee',	                                            'FCA349'],
			[''],
			['Translators'],
			['Jsa010',       	'jsa010',	        "Translated Almost The Entire Mod", 'https://twitter.com/_Jsa010_',   	'FF4922'],
			['DEMOLITIONDON96',	'demolitiondon96',	"Translated All The Warnings",	'https://youtube.com/c/DEMOLITIONDON96',	'03C6FC'],
			[''],
