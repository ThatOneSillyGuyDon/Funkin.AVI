	...
	public function new(script:String) {
       ...
       //set('os', false);
		...
		Lua_helper.add_callback(lua, "addVHSEffect", function(camera:String) {
			...
			PlayState.instance.addShaderToCamera(camera, new VhsHandler());
			
		});
		Lua_helper.add_callback(lua, "addTailsDollEffect", function(camera:String) {
			
			PlayState.instance.addShaderToCamera(camera, new NewVCRDistortionEffect());
