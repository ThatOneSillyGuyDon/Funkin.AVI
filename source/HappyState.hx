...
/**
 * basically after beating "Birthday" Everything Becomes Normal And Not Scary
 * making like your coming to muckney's birthday
 */
package;
...
class HappyState extends MusicBeatState {
	...
	var songs:Array<SongMetadataShit> = [];
	...
	override function create()
	{
		...
		DiscordClient.changePresence("In Freeplay", "Coming To Muckney's Bday!", null, 'icon');
		#end

		Application.current.window.title = "Funkin.avi - Coming To Muckney's Birthday";
	...
	{
		songs.push(new SongMetadataShit(songName, weekNum, songCharacter, color));
	}
	...
	override function update(elapsed:Float)
	{
		...
		if (controls.BACK)
		{
			...
			Application.current.window.alert("Don't Leave In My Birthday :(", 'ERROR:');
		}
