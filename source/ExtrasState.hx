...
class ExtrasState extends MusicBeatState{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("In Freeplay", "Extra Songs", null, 'icon');
		#end

		Application.current.window.title = "Funkin.avi - Freeplay: Extra Songs";
	...
	public function addWeek(songs:Array<String>, weekNum:Int, ?songCharacters:Array<String>, weekColor:Int, difficulties:Array<String>)
	{
		...
		for (song in songs)
		{
			addSong(song, weekNum, songCharacters[num], weekColor, difficulties);
