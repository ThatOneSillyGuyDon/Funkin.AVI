						...
						switch (Math.abs(note.noteData))
						{
							case 0:
								...
								if(ClientPrefs.mechanics)
								{
									...
									if(ClientPrefs.camMove)
									{
										triggerEventNote('Camera Follow Pos','485','450');
									}
								}
							case 1:
								if(curStage == 'Couch')
								...
								if(ClientPrefs.mechanics)
								{
									...
									if(ClientPrefs.camMove)
									{
										triggerEventNote('Camera Follow Pos','520','485');
									}
								}
							case 2:
								if(curStage == 'Couch')
								...
								if(ClientPrefs.mechanics)
								{
									...
									if(ClientPrefs.camMove)
									{
										triggerEventNote('Camera Follow Pos','520','415');
									}
								}
							case 3:
								if(curStage == 'Couch')
								...
								if(ClientPrefs.mechanics)
								{
									...
									if(ClientPrefs.camMove)
									{
										triggerEventNote('Camera Follow Pos','555','450');
									}
								}
						}
			if(note.gfNote) {
			...
			if(!note.noAnimation) {
				...
				switch (Std.int(Math.abs(note.noteData)))
				{
					case 0:
						...
						if(ClientPrefs.camMove)
						{
							triggerEventNote('Camera Follow Pos','785','450');
						}
					case 1:
						animToPlay = 'singDOWN';
						if(curStage == 'Line')
						...
						if(ClientPrefs.camMove)
						{
							triggerEventNote('Camera Follow Pos','820','485');
						}
					case 2:
						animToPlay = 'singUP';
						if(curStage == 'Line')
						...
						if(ClientPrefs.camMove)
						{
							triggerEventNote('Camera Follow Pos','820','415');
						}
					case 3:
						animToPlay = 'singRIGHT';
						if(curStage == 'Line')
						...
						if(ClientPrefs.camMove)
						{
							triggerEventNote('Camera Follow Pos','855','450');
						}
				}
	...
	var curSection:Int = Math.floor(curStep / 16);
		...
		if (curBeat % boyfriend.danceEveryNumBeats == 0 && boyfriend.animation.curAnim != null && !boyfriend.animation.curAnim.name.startsWith('sing') && !boyfriend.stunned)
		{
			...
			if (SONG.notes[curSection].mustHitSection){
				switch(SONG.player1){
					case 'bffake' | 'bffakeNEW':
						triggerEventNote('Camera Follow Pos', '-120', '450');
				}
			}
		}
		if (curBeat % dad.danceEveryNumBeats == 0 && dad.animation.curAnim != null && !dad.animation.curAnim.name.startsWith('sing') && !dad.stunned)
		{
			dad.dance();
			if (!SONG.notes[curSection].mustHitSection){
				triggerEventNote('Camera Follow Pos', '520', '450');
			}
		}
