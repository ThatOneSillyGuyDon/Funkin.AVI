...
class ResetScoreSubState extends MusicBeatSubstate
{
	...
	public function new(song:String, difficulty:Int, character:String, week:Int = -1)
	{
		...
		if(ClientPrefs.language == "Spanish") var text:Alphabet = new Alphabet(0, 180, "Reiniciar La Puntuacion De", true);
		else var text:Alphabet = new Alphabet(0, 180, "Reset the score of", true);
		text.screenCenter(X);
