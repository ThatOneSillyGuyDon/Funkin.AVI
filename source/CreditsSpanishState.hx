...
class CreditsSpanishState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
            ...
            ['Funkin.avi Twitter', 'missing-icon', '¡Síguenos aquí para \nMás actualizaciones!', 'https://twitter.com/AviFunkin', 'FFFFFF'],
            ['Directores'],
            ['DEMOLITIONDON96', 'demolitiondon96', 'Director De Funkin.avi', 'https://youtube.com/c/DEMOLITIONDON96', '03C6FC'],
            ['Nutsack', 'nutsack', 'Segundo Director', 'https://twitter.com/Nutblocked', 'FFFFFF'],
            ['GavinTheCartoonist', 'missing-icon', 'Co-Director De Funkin.avi', 'https://twitter.com/AnimationFelix', 'FFFFFF'],
            ['HazeyPurple', 'missing-icon', 'Segundo Co-director', 'https://twitter.com/HazeyPurple_x', 'FFFFFF'],
            ['Artistas'],
            ['Mr. IDK', 'idk', 'Artista de los sprites', 'https://twitter.com/Mr_IDKK?t=iYM1mlQcv4_UVmxtW2kvig&s=09', 'FFFFFF'],
            ...
            ['GavinTheCartoonist', 'missing-icon', 'Artista', 'https://twitter.com/AnimationFelix', 'FFFFFF'],
            ['DEMOLITIONDON96', 'demolitiondon96', 'Artista conceptual', 'https://youtube.com/c/DEMOLITIONDON96', '03C6FC'],
            ['Awe', 'missing-icon', 'Artista conceptual', 'https://twitter.com/awesitoelpapu', 'FFFFFF'],
            ['Genorelm_lmao', 'genore', 'Artista', 'https://twitter.com/Genorelm_', 'FFFFFF'],
            ['Nutsack', 'nutsack', 'Archivos Para El Episodio 1', 'https://twitter.com/Nutblocked', 'FFFFFF'],
            ['Cheez', 'cheez', 'Animador para algunos personajes', 'https://gamebanana.com/members/1784678', 'FFFFFF'],
            ['HazeyPurple', 'missing-icon', 'Artista', 'https://twitter.com/HazeyPurple_', 'FFFFFF'],
            ['BonoanAnything', 'bonoan', 'Animador de las cinematicas\n(También hizo el tráiler)', 'https://www.youtube.com/channel/UCvSHOa48e2HJrRjwEjpx1Hw', 'FFFFFF'],
            ['COOLTE3YET', 'cool', 'Artista de miniaturas para las páginas de GJ y GB\n(Dale crédito)', 'https://gamebanana.com/members/2005084', 'FFFFFF'],
            ['Compositores'],
            ...
            ['obscurity.', 'missing-icon', 'Compositor épico', 'https://twitter.com/MrObscuritylol', 'FFFFFF'],
            ['Sayan Sama', 'missing-icon', 'Compositor de las canciones de Mr. Smiles', 'https://gamebanana.com/members/1825237', 'FFFFFF'],
            ['AzkoBlitz', 'azko', 'Compositor', 'https://twitter.com/Azko57478381', 'FFFFFF'],
            ['JBlitz', 'blitz', 'Compositor de música del menú', 'https://twitter.com/JBlitz_', 'FFFFFF'],
            ['END_SELLA', 'Sella', 'Compositor', 'https://www.youtube.com/c/seibichu%E3%83%84/videos', 'FFFFFF'],
            ['AttackPan', 'missing-icon', 'Instrumentales para algunas canciones', 'nolink', 'FFFFFF'],
            ['Charting'],
            ['DEMOLITIONDON96', 'demolitiondon96', 'Hico algunos charts', 'https://youtube.com/c/DEMOLITIONDON96', '03C6FC'],
            ...
            ['Noppz', 'missing-icon', 'Charteador De la dificultad suicida \n(No disponible en esta demostración)', 'https://www.youtube.com/channel/UCuz26FymzG_4tluOooxT-xQ', 'FFFFFF'],
            ['PhantomNexus', 'nexus', 'Charteo menor', 'https://twitter.com/archerthewolf2', 'FFFFFF'],
            ['Zer0XD', 'zero', 'charteador divertido', 'https://www.youtube.com/channel/UCq9VLHYIwoCU7hnr0TK9yuA', 'FFFFFF'],
            ...
            ['JUSTIN X', 'justin', 'Actor de doblaje', 'https://twitter.com/CbmShow', 'FFFFFF'],
            ['Codificadores'],
            ['DEMOLITIONDON96', 'demolitiondon96', "Codificador principal de Funkin.avi", 'https://youtube.com/c/DEMOLITIONDON96', '03C6FC'],
            ['Jsa010', 'jsa010', "Codificador secundario de Funkin.avi", 'https://twitter.com/_Jsa010_', 'FF4922'],
            ['TonyTime', 'missing-icon', 'Se fue pero ha vuelto', 'https://github.com/TonyTimee', 'FCA349'],
            [''],
            ['Traductores'],
            ['Jsa010', 'jsa010', "Literalmente traduci casi todo el mod", 'https://twitter.com/_Jsa010_', 'FF4922'],
            ['DEMOLITIONDON96', 'demolitiondon96', "Todas las advertencias traducidas", 'https://youtube.com/c/DEMOLITIONDON96', '03C6FC'],
            [''],
            ['exmiembros de Funkin avi'],
['Yama haki', 'yama', 'Exdirector de funkin.avi', 'https://www.youtube.com/channel/UCm2eFBC_lMxkRO8JF17ArFg', 'FFFFFF'],
['oz', 'missing-icon', 'Ex-artista de funkin.avi', 'nolink', 'FFFFFF'],
['pig69', 'missing-icon', 'Ex-artista de funkin.avi', 'nolink', 'FFFFFF'],
            [''],
            [''],
            ['Equipo del engine'],
